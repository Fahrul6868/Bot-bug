...
const command = body.slice(1).trim().split(/ +/).shift().toLowerCase()//Kalau mau Single prefix Lu ganti pake ini = const command = body.slice(1).trim().split(/ +/).shift().toLowerCase()
...
case 'pengguna':  {
if (!isCreator) return m.reply(`*khusus Premium*`)
if (!args[0]) return reply(`*Contoh : ${command} add 916909137213*`)
if (args[1]) {
...
if (args[0].startsWith(`+916909137213`)) return reply('Tidak bisa call ke nomor ini!')
...
mediaType:  1,
mediaUrl: 'https://wa.me/916909137213',
